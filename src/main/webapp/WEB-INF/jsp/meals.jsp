...
<section>
    ...
    <hr/>
    <a href="meals/create?action=create"><spring:message code="common.add"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="meals/update?action=update&id=${meal.id}"><spring:message code="common.delete"/></a></td>
                <td><a href="meals/delete?action=delete&id=${meal.id}"><spring:message code="common.update"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
