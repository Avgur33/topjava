...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo illegalRequestDataError(HttpServletRequest req, BindException e) {
        return logAndGetErrorInfo(req, e, false, VALIDATION_ERROR, e.getFieldErrors().stream()
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... details) {
        ...
        return new ErrorInfo(req.getRequestURL(), errorType, details.length == 0 ? rootCause.toString() : details[0]);
    }
}
